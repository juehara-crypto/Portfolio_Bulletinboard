...
import com.company.bulletinboard.action.admin.bulletinboard.InsertBulletinboardAction;
...
public class InsertUserAction extends BaseAction {
	...
	private static final Logger logger = LogManager.getLogger(InsertUserAction.class);
	...
	public String mainProc() throws Exception {
		...
		// SQLを生成
		String sql = "INSERT INTO users(user_id, user_name, password, auth_type, delete_flag, delete_day) VALUES(?,?,?,?,?,?)";
		...
		try (Connection connection = DatabaseConnectionManager.getConnection();
			...
			ps.setInt(4, user.getAuth_type());
			ps.setInt(5, user.getDelete_flag());
			ps.setString(6, user.getDelete_day());
